...
const RiderLayout = ({ children }) => {
  ...
  const navigation = [
    { name: 'Overview', href: '/rider/overview', icon: LayoutDashboard },
    { name: 'My Family', href: '/rider/profile', icon: Users },
    { name: 'Find Drivers', href: '/rider/search', icon: Search },
    { name: 'Bookings', href: '/rider/bookings', icon: Calendar },
