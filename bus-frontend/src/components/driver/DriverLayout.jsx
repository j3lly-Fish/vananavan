...
const DriverLayout = ({ children }) => {
  ...
  const navigation = [
    { name: 'Overview', href: '/driver/overview', icon: LayoutDashboard },
    { name: 'Profile', href: '/driver/profile', icon: User },
    { name: 'Routes', href: '/driver/routes', icon: Route },
    { name: 'Bookings', href: '/driver/bookings', icon: Calendar },
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transform transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Driver Portal</span>
            </div>
